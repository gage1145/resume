...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Established a Django framework laboratory information management system for storing and reporting client data.
    ...
    \section{Software}
        ...
        \begin{highlights}
            ...
            \item Tools Used: Python, Django, AWS, Bash
        \end{highlights}


    \section{Presentations}

        \pres{2025}{The next stage of environmental surveillance for CWD: What can we learn from testing scrape sites?}{M. Huang, S. Demarais, S. Lichtenberg, B. Strickland, T. Wolf, E. Michel, \me, M. Ruiz-Aravena}{Wildlife Disease Association Annual Meeting, Victoria, BC, Canada}
